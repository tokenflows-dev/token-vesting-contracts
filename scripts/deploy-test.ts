...
async function main() {
    ...
    const linearVestingProjectAddress = await projectFactory.getCollectionAddress(0)
    console.log(`New linear vesting project deployed to ${linearVestingProjectAddress}`);
}
